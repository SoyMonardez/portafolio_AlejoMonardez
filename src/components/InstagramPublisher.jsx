...
import { FiUploadCloud, FiInstagram, FiExternalLink, FiX, FiPlus } from 'react-icons/fi';

const MAX_IMAGES = 10;

export default function InstagramPublisher() {
    const [files, setFiles]             = useState([]);      // Array<{ file, preview }>
        ...
        <div className="max-w-2xl mx-auto space-y-8">
            <div>
                ...
                <p className="text-white/40 text-sm">
                    Subí hasta {MAX_IMAGES} fotos — 1 foto publica directamente, 2+ publica como carousel.
                    La IA redacta el caption con hashtags.
                </p>
            </div>
            ...
            <form onSubmit={handlePublish} className="space-y-6">
                ...
                <button
                    type="submit"
                    disabled={!files.length || !description.trim() || status === 'loading'}
                ...
                >
                    {status === 'loading' ? (
                        <>
                            ...
                            {isCarousel ? 'Creando carousel...' : 'Generando caption y publicando...'}
                        </>
                    ) : (
                        <>
                            <FiInstagram size={14} />
