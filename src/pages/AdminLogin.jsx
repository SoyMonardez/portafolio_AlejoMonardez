...
export default function AdminLogin() {
  ...
  useSeo({ title: 'Admin — Alejo Monardez', noindex: true, canonical: null });
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          ...
          <div className="relative">
            <input
              ...
              className="w-full bg-transparent border-b border-white/20 py-2 text-center text-white focus:border-white focus:outline-none transition-colors pr-8"
            />
            <button
              type="button"
